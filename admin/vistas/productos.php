...
<div class="modal-body">
       <form id="frmproductoe">
        <div class="row">
            ...
            <label>Imagen (*)</label>
            <input type="text" class="form-control" id="txtimagene" name="txtimagene">
    ...
    switch (val) {
        case "Traer":
                    $.ajax({
                        ...
                        $('#txtprecioce').val(dato['precio_normal']);
                        ...
                        $('#btneditar').unbind().click(function(){
                            ...
                            cate = $("#txtcategoriae").val();
                             oka = {
						                "txtnombree" : noma , "txtdescripcione" : des ,"id_producto" : id,
                                        "txtprecioce" : pc, "txtpreciove" : pv,
                                        "txtstocke" : sto, "txtimagene" : ima,
                                        "txtcategoriae" : cate,
                                };
                            //alert(oka);
